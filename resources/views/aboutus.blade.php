    ...
    <div class="about-intro-area">
        <div class="container position-relative h-100 d-flex align-items-center">
            ...
            <div class="intro-left">
                <img src="{{ asset('frontend') }}/assets/images/about-image/intro-left.png" alt="" class="intro-left-image">
            </div>
            <div class="intro-right">
                <img src="{{ asset('frontend') }}/assets/images/about-image/intro-right.png" alt="" class="intro-right-image">
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 d-flex">
                    <div class="service-left align-self-center align-items-center">
                        <img src="{{ asset('frontend') }}/assets/images/about-image/srevice-left-img.png" alt="" class="service-left-image">
                    </div>
                </div>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="testi-inner">
                            ...
                            <div class="testi-author">
                                <div class="author-img">
                                    <img src="{{ asset('frontend') }}/assets/images/testimonial-image/1.png" alt="">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testi-inner">
                            ...
                            <div class="testi-author">
                                <div class="author-img">
                                    <img src="{{ asset('frontend') }}/assets/images/testimonial-image/2.png" alt="">
                                </div>
                                <div class="author-name">
                    ...
                    <div class="swiper-slide">
                        <div class="testi-inner">
                            ...
                            <div class="testi-author">
                                <div class="author-img">
                                    <img src="{{ asset('frontend') }}/assets/images/testimonial-image/3.png" alt="">
                                </div>
                                <div class="author-name">
            ...
            <div class="brand-slider swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('frontend') }}/assets/images/brand-logo/1.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('frontend') }}/assets/images/brand-logo/2.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('frontend') }}/assets/images/brand-logo/3.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('frontend') }}/assets/images/brand-logo/4.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('frontend') }}/assets/images/brand-logo/5.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
