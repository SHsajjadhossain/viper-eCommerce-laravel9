                ...
                <div class="single-blog">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="{{ asset('frontend/assets/images/blog-image/1.jpg') }}"
                                class="img-responsive w-100" alt="blog-image-1"></a>
                    </div>
                    <div class="blog-text">
                    ...
                    <div class="blog-post-media swiper-container slider-nav-style-1 small-nav">
                        <div class="blog-gallery swiper-wrapper">
                            <div class="gallery-item swiper-slide">
                                <a href="#"><img src="{{ asset('frontend/assets/images/blog-image/3.jpg') }}" alt="blog" /></a>
                            </div>
                            <div class="gallery-item swiper-slide">
                                <a href="#"><img src="{{ asset('frontend/assets/images/blog-image/2.jpg') }}" alt="blog" /></a>
                            </div>
                            <div class="gallery-item swiper-slide">
                                <a href="#"><img src="{{ asset('frontend/assets/images/blog-image/1.jpg') }}" alt="blog" /></a>
                            </div>
                        </div>
                        <!-- Add Arrows -->
