...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-6 col-xl-3">
                        <div class="card-box mb-0 widget-chart-two">
                            ...
                            <div class="widget-chart-two-content">
                                ...
                                <h3 class=""><i class="fa fa-users"></i> {{ $total_users }}</h3>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-6 col-xl-3">
                        <div class="card-box mb-0 widget-chart-two">
                            ...
                            <div class="widget-chart-two-content">
                                ...
                                <h3 class=""><i class="fa fa-user-secret"></i> {{ $total_admin }}</h3>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-6 col-xl-3">
                        <div class="card-box mb-0 widget-chart-two">
                            ...
                            <div class="widget-chart-two-content">
                                ...
                                <h3 class=""><i class="fa fa-users"></i> {{ $total_customer }}</h3>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-6 col-xl-3">
                        <div class="card-box mb-0 widget-chart-two">
                            <div class="float-right">
                                <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                    data-fgColor="#2d7bf4" value="{{ $total_vendor }}" data-skin="tron" data-angleOffset="180"
                                    data-readOnly=true data-thickness=".1" />
                            </div>
                            <div class="widget-chart-two-content">
                                <p class="text-muted mb-0 mt-2">Total Vendor</p>
                                <h3 class=""><i class="fa fa-user"></i> {{ $total_vendor }}</h3>
                            </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card-box">
                <h4 class="m-t-0 header-title">Admin VS Customer Vs Vendor</h4>
...
//plot graph data
var uploads = [[0, 13], [1, 13], [2, 14], [3, 62], [4, 13], [5, 10], [6, 56],[7, 13], [8, 12], [9, 20], [10, 48], [11,
16], [12, 14]];
var downloads = [[0, 8], [1, 10], [2, 12], [3, 14], [4, 36], [5, 7], [6, 9],[7, 10], [8, 41], [9, 17], [10, 15], [11,
13], [12, 11]];
var downloads1 = [[0, 3], [1, 22], [2, 8], [3, 10], [4, 7], [5, 3], [6, 5],[7, 7], [8, 6], [9, 14], [10, 35], [11, 10],
[12, 8]];
...
//Combine graph data
var data24Hours = [[0, 201], [1, 520], [2, 337], [3, 261], [4, 157], [5, 95], [6, 200], [7, 250], [8, 320], [9, 500],
[10, 152], [11, 214], [12, 364], [13, 449], [14, 558], [15, 282], [16, 379], [17, 429], [18, 518], [19, 470], [20, 330],
[21, 245], [22, 358], [23, 74]];
var data48Hours = [[0, 311], [1, 630], [2, 447], [3, 371], [4, 267], [5, 205], [6, 310], [7, 360], [8, 430], [9, 610],
[10, 262], [11, 324], [12, 474], [13, 559], [14, 668], [15, 392], [16, 489], [17, 539], [18, 628], [19, 580], [20, 440],
[21, 355], [22, 468], [23, 184]];
var dataDifference = [[23, 727], [22, 128], [21, 110], [20, 92], [19, 172], [18, 63], [17, 150], [16, 592], [15, 12],
[14, 246], [13, 52], [12, 149], [11, 123], [10, 2], [9, 325], [8, 10], [7, 15], [6, 89], [5, 65], [4, 77], [3, 600], [2,
200], [1, 385], [0, 200]];
var ticks = [[0, "22h"], [1, ""], [2, "00h"], [3, ""], [4, "02h"], [5, ""], [6, "04h"], [7, ""], [8, "06h"], [9, ""],
[10, "08h"], [11, ""], [12, "10h"], [13, ""], [14, "12h"], [15, ""], [16, "14h"], [17, ""], [18, "16h"], [19, ""], [20,
"18h"], [21, ""], [22, "20h"], [23, ""]];
...
var donutlabels = ["Admin", "Customer", "Vendor"];
var donutdatas = [{{ $total_admin }}, {{ $total_customer }}, {{ $total_vendor }}];
var donutcolors = ['#02c0ce','#2d7bf4',"#f9bc0b"];
